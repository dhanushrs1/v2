...
from info import ADMINS, LOG_CHANNEL, OWNER_USERNAME, PRICING_POINTS, SUBSCRIPTION
from utils_extra import get_seconds
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "ɢᴇᴛ ꜰʀᴇᴇ ᴛʀᴀɪʟ ꜰᴏʀ 𝟻 ᴍɪɴᴜᴛᴇꜱ ", callback_data="give_trial"
                )
            ],
            [
                InlineKeyboardButton(

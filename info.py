...
# Toggle for auto-approving AUTH_REQ_CHANNEL join requests (private)
AUTO_APPROVE_AUTH_REQ_CHANNEL = environ.get("AUTO_APPROVE_AUTH_REQ_CHANNEL", "True").lower() in ("true", "1", "yes", "y")
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", ""))
LOG_API_CHANNEL = int(environ.get("LOG_API_CHANNEL", ""))
LOG_VR_CHANNEL = int(environ.get("LOG_VR_CHANNEL", ""))
REDIRECT_CHANNEL = int(environ.get("REDIRECT_CHANNEL", "-1001982864590"))
CHANNEL_ID = int(environ.get("CHANNEL_ID", "-1001948607793")) #move request search channel
DEFAULT_GROUP_ID = int(environ.get("DEFAULT_GROUP_ID", "-1002033041165"))
...
STREAM_MODE_USER = is_enabled(environ.get("STREAM_MODE_USER", "True"), True)
